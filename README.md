...
- **App 图标**：适配 iOS 18+ 深色/浅色模式，使用独立 Dark/Light 变体图标
- **键盘工具栏**：AI 决策与设置提示词编辑器中，键盘顶部增加"完成"按钮，方便收键盘
- **卡片样式微调**：卡片底色改用 `secondarySystemGroupedBackground`，边缘增加分隔线描边，与系统分组列表视觉对齐
